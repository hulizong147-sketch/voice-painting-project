...
- Object operations: select all, delete selected, delete by description, copy, paste, duplicate, move, scale, rotate, flip, align, distribute, style, bring forward, send backward.
